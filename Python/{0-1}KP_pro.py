...
capacity = 10149
weight = [
    508, 1021, 1321, 111, 1098, 1196, 204, 939, 1107, 399, 474, 719, 803, 1054,
    1781, 525, 1050, 1362, 530, 641, 903, 432, 583, 894, 754, 806, 1241, 1056,
    1092, 1545
]
profit = [
    408, 921, 1329, 11, 998, 1009, 104, 839, 943, 299, 374, 673, 703, 954,
    1657, 425, 950, 1375, 430, 541, 971, 332, 483, 815, 654, 706, 1360, 956,
    992, 1948
]
...
rd3.pack()
rd4 = Radiobutton(root, text="贪心法", variable=var, value=3, command=Mysel)
rd4.pack()
rd5 = Radiobutton(root, text="遗传算法", variable=var, value=4, command=Mysel)
rd5.pack()
